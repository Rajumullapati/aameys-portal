...
export default class TeacherClassStudentInfo extends Component {
    constructor(props){
        super(props);
        this.state = {
            ...
            <div style={{backgroundColor:"orange",height:"500px",opacity:"0.65"}}> 
                <Row className="page-title">
                    ...
                    <Col style={{marginTop:"10px", marginLeft:"10px"}} sm={6} lg={4} >
                        ...
                        <BreadcrumbItem>{this.state.class} </BreadcrumbItem>
                        <BreadcrumbItem>Students </BreadcrumbItem>

                        <BreadcrumbItem >{this.state.fname} {this.state.lname}</BreadcrumbItem>
