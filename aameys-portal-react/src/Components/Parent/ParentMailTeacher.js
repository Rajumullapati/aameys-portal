...
export default class ParentMailTeaher extends Component {
    constructor(props){
        super(props);
        this.state = {
            teachers:[],
                        ...
                        <Card style={{margin: "10px"}}>
                            <CardBody>
                                ...
                                <BootstrapTable
                                        ...
                                        >
                                        <TableHeaderColumn width='100' dataField='name'  dataFormat={this.parentFormatter} isKey={true}>Parent Name</TableHeaderColumn>
