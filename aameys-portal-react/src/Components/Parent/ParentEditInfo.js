                ...
                <Col lg={5} md={5} sm={5}>
                    <form lg={5} onSubmit={this.handleSubmit}>
                        <Row className="form-group">
                            <label htmlFor="parent_name_first" className="col-sm-2 col-form-label" ><span style={{color:"black", fontSize:"150%", marginRight:"3px"}}>First</span></label>
                            <Col sm={10} >
                                <input type="text" className="form-control" id="parent_name_first" onChange={this.onChange} name="parent_name_first" value={this.state.parent_name_first}  placeholder={this.state.admin_name_first}/>
                            </Col>
                        </Row>
                        <Row className="form-group">
                            <label htmlFor="parent_name_last" className="col-sm-2 col-form-label"><span style={{color:"black", fontSize:"150%", marginRight:"3px"}}>Last</span></label>
                            <Col sm={10} >
                                <input type="text" className="form-control" id="parent_name_last" placeholder="Last" onChange={this.onChange} name="parent_name_last" value={this.state.parent_name_last} />
                            </Col>
                        </Row>
                        <Row className="form-group">
                            <label htmlFor="parent_mail" className="col-sm-2 col-form-label"><span style={{color:"black", fontSize:"150%", marginRight:"3px"}}>Email</span></label>
                            <Col sm={10} >
                                <input type="email" className="form-control" id="parent_mail" placeholder="Email" onChange={this.onChange} name="parent_mail" value={this.state.parent_mail} />
                            </Col>
                        </Row>
