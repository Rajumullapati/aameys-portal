              ...
              <BreadcrumbItem active>Administrator</BreadcrumbItem>
                ...
                <Col lg={3} md={3} sm={3} className="mb-30"></Col>
                    ...
                    <div style={{margin:"10px"}}>
                        <Link to={{pathname:`${this.state.admin_id}/editinfo`}}><Button style={{marginBottom:"4px", width:"70%", textAlign: "left", backgroundColor:"grey"}} type="button" className="btn btn-sm"><i style={{marginRight:"10px"}} className="fa fa-id-card-o"></i>My account</Button></Link>
                        <Link to={{pathname:`${this.state.admin_id}/emailteacher`}}><Button style={{marginBottom:"4px", width:"70%", textAlign: "left", backgroundColor:"grey"}} type="button" className="btn btn-sm"><i style={{marginRight:"10px"}} className="fa fa-envelope-o"></i>Email teachers</Button></Link>
                        <Link to={{pathname:`${this.state.admin_id}/emailstudent`}}><Button style={{marginBottom:"4px", width:"70%", textAlign: "left", backgroundColor:"grey"}} type="button" className="btn btn-sm"><i style={{marginRight:"10px"}} className="fa fa-envelope-o"></i>Email students</Button></Link>
                        <Link to={{pathname:`${this.state.admin_id}/emailparent`}}><Button style={{marginBottom:"4px", width:"70%", textAlign: "left", backgroundColor:"grey"}} type="button" className="btn btn-sm"><i style={{marginRight:"10px"}} className="fa fa-envelope-o"></i>Email parents</Button></Link>
                    </div>
                    </Col>
                </Row>
