            ...
            <div style={{backgroundColor:"orange",height:"500px",opacity:"0.65"}}> 
                ...
                <Col lg={1} md={1} sm={1} className="mb-30"></Col>
                    ...
                    <div style={{margin:"10px"}}>
                        ...
                        <Link to={{pathname:`${this.state.student_id}/removeclass`}}><Button style={{marginBottom:"4px", width:"130%", textAlign: "left", backgroundColor:"grey"}} type="button" className="btn btn-sm"><i style={{marginRight:"10px"}} className="fa fa-id-card-o"></i>Remove classes</Button></Link>
