        ...
        return (
            ...
            <Col>
                ...
                <Col sm={4} lg={4} md={4} style={{paddingRight:"0px"}}>
                    ...
                    <div style={{textAlign:"center"}}><Link><i style={{ fontSize:"140px"}} className="fa fa-graduation-cap"></i>
                ...
                <Col sm={4} lg={4} md={4} style={{padding:"0px"}}>
                    ...
                    <div style={{textAlign:"center"}}><Link><i style={{fontSize:"140px"}} className="fa fa-id-card-o"></i>
                ...
                <Col sm={4} lg={4} md={4} style={{paddingLeft:"0px"}}>
                    ...
                    <div style={{ textAlign:"center"}}><Link><i style={{fontSize:"130px", marginBottom:"10px"}} className="fa fa-calendar-minus-o"></i>
